          ...
          >
            <svg
              ...
              className={`fill-current ${
                props.wishItems[props.Account]?.includes(product) ? "text-red-500" : "text-gray-800"
              } inline-block`}
              viewBox="0 0 64 64"
            >
              <path
          ...
          >
            ...
            <div className="flex items-center justify-between mt-6 pb-5 border-b-2 border-gray-200 mb-5">
              <div className="flex items-center space-x-2">
                <img src="https://www.svgrepo.com/show/491795/delivery-truck-ui-2.svg" alt="deliver" className="w-5 h-5" />
                <span>Home Delivery</span>
              </div>
              <div className="flex items-center space-x-2">
                <img src="https://www.svgrepo.com/show/505386/gift.svg" alt="gift" className="w-7 h-7" />
                <button onClick={console.log(`Welcome`)}>Click & Collect</button>
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="flex flex-col justify-center items-center"> 
      <div className="mb-4 border-b border-gray-200 dark:border-gray-700">
          <ul className="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist">
            <li className={`me-2 ${activeTab === "promotion" ? "active-tab" : ""}`} role="presentation">
              <button className="inline-block p-4 border-b-2 rounded-t-lg" id="promotion-tab" data-tabs-target="#promotion" type="button" role="tab" aria-controls="promotion" aria-selected={activeTab === "promotion"} onClick={() => handleTabClick("promotion")}>Promotion</button>
            </li>
            <li className={`me-2 ${activeTab === "description" ? "active-tab" : ""}`} role="presentation">
              <button className="inline-block p-4 border-b-2 rounded-t-lg" id="description-tab" data-tabs-target="#description" type="button" role="tab" aria-controls="description" aria-selected={activeTab === "description"} onClick={() => handleTabClick("description")}>Description</button>
            </li>
            <li className={`me-2 ${activeTab === "reviews" ? "active-tab" : ""}`} role="presentation">
              <button className="inline-block p-4 border-b-2 rounded-t-lg" id="reviews-tab" data-tabs-target="#reviews" type="button" role="tab" aria-controls="reviews" aria-selected={activeTab === "reviews"} onClick={() => handleTabClick("reviews")}>Reviews</button>
            </li>
          </ul>
        </div>
      <div id="default-tab-content">
        <div className={`p-4 rounded-lg bg-gray-50 dark:bg-gray-800 ${activeTab === "promotion" ? "" : "hidden"}`} id="promotion" role="tabpanel" aria-labelledby="promotion-tab">
          <ProductPromotion />
        </div>
        <div className={`p-4 rounded-lg bg-gray-50 dark:bg-gray-800 ${activeTab === "description" ? "" : "hidden"}`} id="description" role="tabpanel" aria-labelledby="description-tab">
          <ProductDetail descriptions={descriptions} productId={product.id} />
        </div>
        <div className={`p-4 rounded-lg bg-gray-50 dark:bg-gray-800 ${activeTab === "reviews" ? "" : "hidden"}`} id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
          {[...Array(5)].map((_, index) => (
