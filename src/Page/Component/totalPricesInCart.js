function TotalPriceCount({ ItemInfo }) {
  ...
  return (
    <>
      <div className="bg-gray-300 rounded-md p-5 font-bold text-2xl md:flex items-center space-x-4">
        <img
        ...
        <p className="md:w-1/5 text-center md:text-right">{ItemInfo.qty}</p>
        <p className="md:w-1/5 text-center md:text-right">${TotalPrice}</p>
      </div>
    </>
  );
}
