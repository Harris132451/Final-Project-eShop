      ...
      {item.map((product) => (
        <div className="max-w-[384px] mx-auto" key={product.id}>
          ...
          <div className="mt-5 flex items-center justify-between">
            ...
            <Link to="Checkout" onClick={() => handleAddToCart(product.id)} className="p-2 min-[400px]:p-4 rounded-full bg-white border border-gray-300 flex items-center justify-center group shadow-sm shadow-transparent transition-all duration-500 hover:shadow-gray-200 hover:border-gray-400 hover:bg-gray-50">
              <svg
