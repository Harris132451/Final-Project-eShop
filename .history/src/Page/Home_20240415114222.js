        ...
        {randomItems.map((filteredItem) => (
          ...
          >
            ...
            <div className="flex justify-between">
                <button
                  type="button"
                  className="w-1/2 mt-6 px-4 py-3 bg-[#333] hover:bg-[#222] text-white rounded-full"
                  onClick={() => {
                ...
                <button className="w-1/2 mt-6 px-4 py-3 bg-[#333] hover:bg-[#222] text-white rounded-full">
