...
function Header(props) {
  ...
  return (
    <>
      ...
      .map(bigcategorie => (
        <li key={bigcategorie.id} className="list-none group relative cursor-pointer text-darkGrayishBlue transition-all hover:border-b-4 border-orange hover:pb-[53px] hover:text-black">
