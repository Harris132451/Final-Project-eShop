...
import SubcategoryPage from "./Page/Component/SubcategoryPage.js";
    ...
    <>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          />
          <Route exact path="/:categoryName" component={CategoriesPage} />
          <Route path="/:categoryName/:subcategoryName" component={SubcategoryPage} />
        </Routes>
      </BrowserRouter>
      <Footer />
    </>
