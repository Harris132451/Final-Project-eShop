...
export default function App() {
  ...
  return (
    <>
      ...
      <Route
        index
        element={isLoading ? <LoadingSpinner /> : <Home updateCart={updateCart} updateIsOpenCart={updateIsOpenCart} />}
      />
      <Route
        path="Checkout"
        element={isLoading ? <LoadingSpinner /> : <Checkout updateCart={updateCart} CartItem={cart} Account={AccountName} />}
      />
      <Route
        path="Signin"
        element={isLoading ? <LoadingSpinner /> : <Signin updateAccountName={updateAccountName} />}
      />
      <Route
        path="/:categoryName"
        element={isLoading ? <LoadingSpinner /> : <CategoriesPage updateCart={updateCart} updateIsOpenCart={updateIsOpenCart} />}
      />
      <Route
        path="/:categoryName/:smallCategoriesName"
        element={isLoading ? <LoadingSpinner /> : <SmallCategoriesPage updateCart={updateCart} updateIsOpenCart={updateIsOpenCart} />}
      />
      <Route
        path="/products/:productPage"
        element={isLoading ? <LoadingSpinner /> : <ProductPage updateCart={updateCart} updateIsOpenCart={updateIsOpenCart} />}
      />
    </Routes>
      </BrowserRouter>
      <Footer />
